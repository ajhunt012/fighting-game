...
const player = new Fighter({
    ...
    sprites: {
        ...
        run: {
            imageSrc: 'images/Martial Hero/Sprites/Run.png',
            framesMax: 8
        },
        jump: {
            imageSrc: 'images/Martial Hero/Sprites/Jump.png',
            framesMax: 2
        },
        fall: {
            imageSrc: 'images/Martial Hero/Sprites/Fall.png',
            framesMax: 2
        },
        attack1: {
            imageSrc: 'images/Martial Hero/Sprites/Attack1.png',
            framesMax: 6
        },
        takeHit: {
            imageSrc: 'images/Martial Hero/Sprites/Take Hit - white silhouette.png',
            framesMax: 4
        },
        death: {
            imageSrc: 'images/Martial Hero/Sprites/Death.png',
            framesMax: 6
        }
    },
    attackBox: {
